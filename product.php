...
<!--	<h1 class="page-header text-center">PRODUCTS CRUD</h1> -->
	<div class="row">
		...
		<!--	<option value="0">All Category</option> -->
			...
			<a href="#addproduct" data-toggle="modal" class="pull-right btn btn-primary"><span class="glyphicon glyphicon-plus"></span>
			 اضافه کردن محصول</a>
		</div>
	</div>
			...
			<tbody>
				<?php
					...
					while($row=$query->fetch_array()){
						?>
						<tr>
							<td><a href="<?php if(empty($row['photo'])){echo "upload/noimage.jpg";} else{echo $row['photo'];} ?>">
							<img src="<?php if(empty($row['photo'])){echo "upload/noimage.jpg";} else{echo $row['photo'];} ?>
						...
						‍		
							<td>
								...
								<span class="glyphicon glyphicon-pencil"></span> ویرایش</a> || <a href="#deleteproduct<?php echo $row['productid']; ?>" 
